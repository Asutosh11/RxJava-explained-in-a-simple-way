...
public class FlatMap extends AppCompatActivity {
     ...
     *    merging every item from observableOne with a static string 'after thru flatMap'.
     */

    private Disposable disposable;
    String TAG = "print_data_flatMap";
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        Observable<String> observableTwo = observableOne.flatMap(new Function<String, ObservableSource<String>>(){
            @Override
            public ObservableSource<String> apply(String t) throws Exception {
                return Observable.just(t+" after thru flatMap").delay(200, TimeUnit.MILLISECONDS);
